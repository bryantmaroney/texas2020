...
jQuery(document).ready(function($){
	...
	const cardRoutes = {
		end_gerry: "https://texas2020.org/?EndGerrymandering",
		vote_by_mail: "https://texas2020.org/?VoteByMail",
		reval_writers: "https://texas2020.org/?RevealtheWriters",
		modern_election: "https://texas2020.org/?RCV",
		rank_candidate: "https://texas2020.org/?RethinkRegistration",
		reth_reg: "https://texas2020.org/?BantheBarriers",
		limit_lob: "https://texas2020.org/?ModernizeElections",
		ban_barriers: "https://texas2020.org/?CleanUpElections",
		clean_up: "https://texas2020.org/?LimittheLobbyists",
		tune_in_texas: "https://texas2020.org/?TuneinTexas"
	}

	function routeCards(slide) {
		let route = slide.find('.buttons').find('.agree').data('name');
		// window.history.pushState("", "", cardRoutes[route]);
	}
	/*
	...
	* that the logic inside the function is executed immediately. 
	 ...
	 */
		...
		Zippy.prototype.build = function(){
			var $indicators = this.$el.append('<ul class="indicators animate__animated " >').find('.indicators');
